...
int main(){
	...
	//team->run();
		...
		cout<<"3. Test car in Wind Tunnel:"<<endl;
		cout<<"\tTokens: "<<test.getToken()<<endl;
		cout<<"4. Begin Races:"<<endl;
		cin>>x;
		...
		switch(x){		
			...
			case 2:
				...
				break;
			case 3:
				cout<<"HOW MANY TOKENS WOULD YOU LIKE TO USE (ENTER INT):"<<endl;
				cin>>y;
				test.checkWindTunnel(y);
				break;
			case 4:
				if(neuC == 0 && euC == 0){
					cout<<"\n***MUST ADD RACES***\n"<<endl;
